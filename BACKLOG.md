...
> **Last updated:** 2026-04-24 (Sprint 16)
...
| Date | Change |
|------|--------|
| 2026-04-24 | Documentation refresh: PRD/PLAN/DIAGRAM synchronized with live backend routes and ERD; added public testimonials endpoint note (`GET /api/reviews/public`). |
