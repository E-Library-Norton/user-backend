...
// Assign roles / direct permissions — requires manage_roles permission
router.post("/:id/roles", userRules.assignRoles, requirePermission("manage_roles"), UserController.assignRoles);
router.post("/:id/permissions", userRules.assignPermissions, requirePermission("manage_roles"), UserController.assignPermissions);
